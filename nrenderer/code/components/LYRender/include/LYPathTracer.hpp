...
namespace LYPathTracer
{
    ...
    private:
        ...
        //----photon mapping
        void rayTracing(const Ray& r, int currDepth, float lambda, int x, int y, bool in);
        ...
        void photonTracing(const Ray& r, Vec3 rColor, int currDepth, int diffCount, bool in);
